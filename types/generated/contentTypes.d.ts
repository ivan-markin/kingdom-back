...
export interface ApiContactsContacts extends Schema.SingleType {
...
export interface ApiHousesParamHousesParam extends Schema.CollectionType {
  collectionName: 'houses_params';
  info: {
    singularName: 'houses-param';
    pluralName: 'houses-params';
    displayName: 'Houses Param';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiIncludedItemIncludedItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::included-item.included-item',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiStageItemStageItem extends Schema.CollectionType {
  collectionName: 'stage_items';
  info: {
    singularName: 'stage-item';
    pluralName: 'stage-items';
    displayName: 'Stage Item';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::houses-param.houses-param': ApiHousesParamHousesParam;
      'api::included-item.included-item': ApiIncludedItemIncludedItem;
      'api::menu-item.menu-item': ApiMenuItemMenuItem;
      'api::stage-item.stage-item': ApiStageItemStageItem;
    }
  }
}
